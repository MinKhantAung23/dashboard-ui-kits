  ...
  return (
    <header className="sticky top-0 z-30 h-14 bg-background border-b border-border flex items-center justify-between px-4 lg:px-6 transition-colors duration-300">
      ...
      <div className="flex items-center gap-1.5 lg:gap-2">
        ...
        {/* Language Switcher */}
        <DropdownMenu>
          <DropdownMenuTrigger className="inline-flex items-center justify-center gap-1.5 px-2 h-8 rounded-md text-muted-foreground font-medium text-xs hover:bg-accent hover:text-accent-foreground transition-colors focus-visible:outline-none">
        ...
        {/* Theme Toggle */}
        <DropdownMenu>
          <DropdownMenuTrigger className="relative inline-flex items-center justify-center h-8 w-8 rounded-md text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors focus-visible:outline-none">
        ...
        {/* Profile Dropdown */}
        <DropdownMenu>
          <DropdownMenuTrigger className="inline-flex items-center relative h-8 w-8 lg:w-auto lg:px-2 gap-2 rounded-full lg:rounded-md ml-1 hover:bg-accent hover:text-accent-foreground transition-colors focus-visible:outline-none">
